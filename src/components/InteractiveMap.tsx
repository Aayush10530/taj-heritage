...
const attractions = [
  ...
  { name: "Fatehpur Sikri", lat: 27.0940, lng: 77.6711, description: "A city founded in 1569 by the Mughal Emperor Akbar." },
  { name: "Itmad-ud-Daulah", lat: 27.1927, lng: 78.0309, description: "Known as 'Baby Taj', this tomb inspired the design of the Taj Mahal." },
  { name: "Mehtab Bagh", lat: 27.1796, lng: 78.0437, description: "A garden complex aligned with the Taj Mahal on the opposite side of the Yamuna River." },
  { name: "Sikandra", lat: 27.2209, lng: 77.9409, description: "The tomb of Akbar the Great, a masterpiece of Mughal architecture." },
  { name: "Ram Bagh", lat: 27.1947, lng: 78.0359, description: "One of the oldest Mughal gardens in India, originally built by Emperor Babur." },
];
